"""Anthropic structured JSON haiku predictions via tool use."""
...
from src.schema import HaikuPrediction, parse_prediction, prediction_json_schema

TOOL_NAME = "submit_haiku_prediction"
...
class AnthropicProvider:
    ...
    def complete_structured(self, prompt: str) -> tuple[HaikuPrediction, float | None]:
        ...
        request: dict = {
            ...
            "tools": [
                {
                    "name": TOOL_NAME,
                    "description": "Submit the haiku for this scenario.",
                    "input_schema": schema,
                }
            ],
